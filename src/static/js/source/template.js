    ...
    var temp = {
        ...
        video: `
            <div id="video-page">
                ...
                <div style="opacity: 0; position: absolute; z-index: -1;" id="subtitle-grave"></div>
        ...
        about: `<div>
            <div id="about">
                ...
                为什么做这网站？
                    ...
                    1. 喜欢网球
                        &nbsp;&nbsp;17年初，在老同学的引导下，开始打网球，顶多是个新手，不过每个星期必打，除非下雨天。没人催我，来回路上1个半小时，就这样打下来了。我想肯定是喜欢在场上奔跑挥拍的感觉。碰到很多喜欢网球的年轻人，我能为大家做什么？
    
                    2. 资料太少而且凌乱
                        &nbsp;&nbsp;像我一样走“野路子”的不少，选个"好看的"基础拍就开始在场上瞎挥，一小戳人坚持了下来，技术日渐长进，动作也开始定型，想进一步肯定需要有前人指导，不然等于做无用功。大多请不起教练的“野路子”选择去网上找视频，但是非常凌乱、稀少、古老，我想是否能用我所学的给大家一个学习网球或者其他运动技能的一个平台。
    
                    3. 工作原因
                        &nbsp;&nbsp;有不少球友年龄可能和我差不多，在职场几年，像颗螺丝钉迷失自我，但我想做的是做有趣对社会有用的事情。
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        ...
                        <div id="timeline">
                            ...
                            <div v-if="timeLineLength" id="waveform" :style="{width: timeLineLength + 'px'}"></div>
